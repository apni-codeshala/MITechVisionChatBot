...
// const model = new genAi.getGenerativeModel({
...
async function run() {
    ...
    const chat = model.startChat({
        history: [
            ...
            {
                role: "model",
                parts: ["Hi there! Thanks for reaching out to MI Tech Vision Institute. Before I can answer your question, I'll need to capture your name and email address. Can you please provide that information?"]
            },
            {
                role: "user",
